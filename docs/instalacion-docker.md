...
| `AZKIN_APP_URL` | URL pública del frontend, usada para armar el link/botón del correo de "recuperar contraseña". Sin ella, ese correo cae a un modo degradado: solo el token en texto plano, sin link clicable. | vacío — **obligatorio para que "recuperar contraseña" sea usable** |
