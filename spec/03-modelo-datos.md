...
export interface IMonitor {
  ...
  // Campos específicos adicionales (Wiki de referencia)
...
| Purga de históricos | `expireAfterSeconds` (TTL nativo) | Corrige la deuda de I/O de eliminaciones secuenciales (DELETE en caliente) |
